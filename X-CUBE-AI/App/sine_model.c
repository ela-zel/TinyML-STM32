...
#define AI_SINE_MODEL_MODEL_SIGNATURE     "8a0a69684fa8bc97425a99e1acaf3f06"
...
#define AI_TOOLS_DATE_TIME   "Thu May 27 21:11:39 2021"
...
AI_STATIC ai_array dense_13_input_output_array;   /* Array #0 */
...
AI_STATIC ai_tensor dense_13_input_output;   /* Tensor #0 */
...
AI_ARRAY_OBJ_DECLARE(
  dense_13_input_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
AI_TENSOR_OBJ_DECLARE(
  dense_13_input_output, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 1), AI_STRIDE_INIT(4, 4, 4, 4, 4),
  1, &dense_13_input_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_13_input_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 128, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_IN_NUM, &dense_13_input_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    dense_13_input_output_array.data = AI_PTR(NULL);
    dense_13_input_output_array.data_start = AI_PTR(NULL);
